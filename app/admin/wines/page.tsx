...
export default function AdminWinesPage() {
  ...
  async function load() {
    ...
    try {
      ...
      setData(json);
      setRows((json.wines ?? []).slice().sort((a: WineSlot, b: WineSlot) => (a.blindNumber ?? 999) - (b.blindNumber ?? 999)));
      setMsg("Geladen ✅");
    } catch (e: any) {
  ...
  return (
    <main style={{ padding: 20, fontFamily: "system-ui", maxWidth: 1100, margin: "0 auto" }}>
      ...
      <p style={{ marginTop: 6, opacity: 0.75 }}>
        Trage Owner/Weingut/Rebsorte/Jahrgang ein. Nach „Reveal“ werden diese Daten auf der Ergebnis-Seite sichtbar.
      </p>
